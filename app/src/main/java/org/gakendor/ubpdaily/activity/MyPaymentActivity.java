...
public class MyPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.put("product_id", String.valueOf(event.getProductId()));
            ...
            public void onImagePicked(File imageFile, EasyImage.ImageSource source, int type) {
                switch (type) {
                    case CODE_CAMERA_1:
                        ...
                        Glide.with(MyPaymentActivity.this).load(imageFile).into(ivUpload);
                        payment.setStatus(2);
                        checkStatus();
                        break;
                    case CODE_GALLERY_1:
                ...
                new MaterialDialog.Builder(MyPaymentActivity.this)
                        ...
                        .itemsCallback(new MaterialDialog.ListCallback() {
                            ...
                            public void onSelection(MaterialDialog dialog, View itemView, int position, CharSequence text) {
                                if (position == 0) {
                                    EasyImage.openCamera(MyPaymentActivity.this, CODE_CAMERA_1);
                                } else if (position == 1) {
                                    EasyImage.openGallery(MyPaymentActivity.this, CODE_GALLERY_1);
                                }
                            }
                        }).show();
            }
