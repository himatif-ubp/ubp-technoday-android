...
public class MyTicketActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.put("tr_id", String.valueOf(getIntent().getStringExtra("pay_id")));

        mobileService.myTicket(map).enqueue(new Callback<Response>() {
            @Override
            ...
            public void onImagePicked(File imageFile, EasyImage.ImageSource source, int type) {
                switch (type) {
                    case CODE_CAMERA_1:
                        ...
                        Glide.with(MyTicketActivity.this).load(imageFile).into(ivUpload);
                        payment.setStatus(2);
                        checkStatus();
                        break;
                    case CODE_GALLERY_1:
    ...
    PermissionListener permissionListener() {
        return new PermissionListener() {
            ...
            public void onPermissionGranted() {
                ...
                new MaterialDialog.Builder(MyTicketActivity.this)
                        .title("Pilih")
                        .items(list)
                        .itemsCallback(new MaterialDialog.ListCallback() {
                            ...
                            public void onSelection(MaterialDialog dialog, View itemView, int position, CharSequence text) {
                                if (position == 0) {
                                    EasyImage.openCamera(MyTicketActivity.this, CODE_CAMERA_1);
                                } else if (position == 1) {
                                    EasyImage.openGallery(MyTicketActivity.this, CODE_GALLERY_1);
                                }
                            }
                        }).show();
            }
